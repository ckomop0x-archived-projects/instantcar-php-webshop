...
<html lang="ru">
  ...
  <link href="/dist/styles.738e81c4735c17045622.css" rel="stylesheet"></head>
  <body>
    <!-- renders header-->
    <div class="wrapper">
      <div class="content">
...
<?if ($addr[1] == 'search' || ($addr[1] == 'auto' && count($addr) == 2)) {
  include_once './pages/filter.php';
 } ?>
<!-- Detail auto page-->
<?if ($addr[1] == 'auto' && count($addr) == 3) {
    $id = searchForArticul($addr[2], $PARSED_DATA['cars']);
...
<div class="footer">
  <div class="row col-12">
    <div class="footer__copy col-12">&copy 2017 Стартёры в Клину</div>
  </div>
</div>
    </div>
  ...
  <script type="text/javascript" src="/dist/index.738e81c4735c17045622.js"></script><script type="text/javascript" src="/dist/styles.738e81c4735c17045622.js"></script></body>
</html>